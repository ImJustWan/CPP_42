...
int main()
{
	...
	try {
		...
		std::cout << _AQUAMARINE "Yes it's in ! ৻(  •̀ ᗜ •́  ৻)\n" _END << std::endl;
	...
	try {
		...
		std::cout << _AQUAMARINE "Yes, test1 is in ! ৻(  •̀ ᗜ •́  ৻)\n" _END << std::endl;
		res = easyfind(myVector, test2);
		std::cout << _AQUAMARINE "Yes, test2 is in ! ৻(  •̀ ᗜ •́  ৻)\n" _END << std::endl;
		res = easyfind(myVector, test3);
		std::cout << _AQUAMARINE "Yes, test3 is in ! ৻(  •̀ ᗜ •́  ৻)\n" _END << std::endl;
	}
	catch(std::exception &e) {
		std::cout << e.what()  << std::endl;
	}
